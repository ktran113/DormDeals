...
def main():
    ...
    (DATA_DIR / f"eval_{args.label}.json").write_text(
        json.dumps({"meta": meta, "records": records}, indent=1))

    summary, _ = report(records, meta, args.label)
